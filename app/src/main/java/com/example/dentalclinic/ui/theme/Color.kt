...
val DentalBackground = Color(0xFFF7FAFC)
val DentalSurface = Color(0xFFFFFFFF)
val DentalText = Color(0xFF172B36)
val DentalMuted = Color(0xFF7A8B97)
...
val DentalSurfaceDark = Color(0xFF1E293B)
val DentalTextDark = Color(0xFFF1F5F9)
val DentalMutedDark = Color(0xFF94A3B8)
val DentalLineDark = Color(0xFF334155)
